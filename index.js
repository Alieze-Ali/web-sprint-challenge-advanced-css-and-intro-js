...
// console.log(artists[8].name = "Vincent van Gough");
...
*/
// function getArtistByIndex(index, artistArray) {
//   /*Your Code Here*/
//   return 'The artist at index ${index["index"]} is ${artistArray["name"]}.'
// }
// console.log(getArtistByIndex(artists["id"], artists["name"]));
...
2. check thru each artist for loop, need split */

function get20s(array){
  /*Your Code Here*/
const newArr = [];
for(let i=0; i<array.length; i++){
  const str = array[i]["years"].split("-");
...
function addArtist(artist){
  artist.push({id:20, name:"Ali", years:"1985 - 2020", genre: "Web Design", nationality: "African-American", bio:"Alieze was born in Pittsburgh, PA. She went to Penn State and is now studying Web Design at Lambda."});
...
// function addArtist(artist){
//   let newArr = artists.push(artist);
//   // console.log(newArr);
//   return newArr;
//   }
//     console.log(addArtist({id:20, name:"Ali", years:"1985 - 2020", genre: "Web Design", nationality: "African-American", bio:"Alieze was born in Pittsburgh, PA. She went to Penn State and is now studying Web Design at Lambda."}));
